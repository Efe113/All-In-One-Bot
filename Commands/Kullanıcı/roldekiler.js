...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!role) return interaction.reply({ content: '<a:dikkat_arviis:1421402093876674641> **Geçerli bir rol seçmedin.**', flags: 64 });
    ...
    if (members.length === 0) {
      return interaction.reply({
        content: `<a:dikkat_arviis:1421402093876674641> <@&${role.id}> **rolünde üye bulunmuyor.**`,
        flags: 64
      });
    }
